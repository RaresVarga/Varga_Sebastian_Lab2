...
namespace Varga_Sebastian_Lab2.Migrations
{
    ...
    [Migration("20231107173804_Borrowingsv2")]
    partial class Borrowingsv2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Varga_Sebastian_Lab2.Models.Author", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Varga_Sebastian_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Varga_Sebastian_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Varga_Sebastian_Lab2.Models.Book", b =>
                {
                    b.HasOne("Varga_Sebastian_Lab2.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID");

                    b.HasOne("Varga_Sebastian_Lab2.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Varga_Sebastian_Lab2.Models.Borrowing", b =>
                {
                    ...
                    b.HasOne("Varga_Sebastian_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
