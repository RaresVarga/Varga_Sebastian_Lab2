...
namespace Varga_Sebastian_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Varga_Sebastian_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Varga_Sebastian_Lab2Context context,
